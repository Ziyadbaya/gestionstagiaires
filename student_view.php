            ...
            <div id="content">
                ...
                <?php
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM candidat WHERE id='$student_id' ";
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src=<?php echo $student['PHOTO'] ?> width="160" height="160">
                                    <div class="mb-3"></div>
                                </div>
                            </div>
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Accepter ou rejecter</h6>
                                </div>
                                <div class="card-body d-xxl-flex justify-content-xxl-center">
                                    <div class="mb-3">
                                    <?php include('message.php'); ?>
                                    <form action="student_modify.php" method="POST" class="d-inline">
                                    <button class="btn btn-success btn-sm" name="accept_student" type="submit" value=<?=$student['id'];?> style="margin-right: 15px;">Accepter<i class="fa fa-check" style="margin-left: 5px;"></i></button>
                                    <button class="btn btn-danger btn-sm" name="reject_student" type="submit" value=<?=$student['id'];?> >Rejeter<i class="fa fa-remove" style="margin-left: 5px;"></i></button></div>
                            </form>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            ...
                            {
                                echo "<h4>Aucun n'utilisateur!</h4>";
                            }
                        }
                        ?>
                                            </form>
