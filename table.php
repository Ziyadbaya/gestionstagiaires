...
$select = " SELECT * FROM candidat WHERE MAIL = '$email'";
   ...
   $select2 = " SELECT * FROM candidat WHERE STATUS = 'traitement'";
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <li class="nav-item"><a class="nav-link" href="admin_index.php"><i class="fas fa-tachometer-alt"></i><span>Tableau de bord</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="table.php"><i class="fas fa-hourglass-half"></i><span>Liste des candidats</span></a></li>
